...
#
# Generated by Vivado on Sat Mar 21 13:52:45 EDT 2026
...
#
#    "/scratch/vivado_ws/PYNQ/boards/ZCU104/base/base/base.srcs/constrs_1/new/base.xdc"
#    "/scratch/vivado_ws/PYNQ/boards/ZCU104/base/base/base.srcs/utils_1/imports/synth_1/base_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/PYNQ/boards/ZCU104/base/base/base.srcs/constrs_1/new/base.xdc"]"\
 "[file normalize "$origin_dir/PYNQ/boards/ZCU104/base/base/base.srcs/utils_1/imports/synth_1/base_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/PYNQ/boards/ip"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../vitis_ws/splicer/splicer/hls/impl/ip"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/PYNQ/boards/ZCU104/base/base"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/PYNQ/boards/ip"] [file normalize "$origin_dir/../vitis_ws/splicer/splicer/hls/impl/ip"]" $obj
...
set file "[file normalize "$origin_dir/PYNQ/boards/ZCU104/base/base/base.srcs/constrs_1/new/base.xdc"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse [list base.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/PYNQ/boards/ZCU104/base/base/base.gen/sources_1/bd/base/hdl/base_wrapper.v" ]
} else {
