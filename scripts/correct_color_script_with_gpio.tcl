...
user.org:user:quadrant_switcher:1.0\
xilinx.com:user:splicer_gpio_config:1.0\
...
proc create_hier_cell_video { parentCell nameHier } {
  ...
  connect_bd_net -net hdmi_in_fid  [get_bd_pins hdmi_in/fid] \
  [get_bd_pins fid]
  connect_bd_net -net net_bdry_in_HDMI_RX_CLK_N_IN  [get_bd_pins HDMI_RX_CLK_N_IN] \
...
proc create_root_design { parentCell } {
  ...
  set header [ create_bd_port -dir O -from 7 -to 0 header ]
...
\
  ...
  # Create instance: quadrant_switcher_1, and set properties
  set quadrant_switcher_1 [ create_bd_cell -type ip -vlnv user.org:user:quadrant_switcher:1.0 quadrant_switcher_1 ]

  # Create instance: splicer_gpio_config_0, and set properties
  set splicer_gpio_config_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:splicer_gpio_config:1.0 splicer_gpio_config_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M19_AXI [get_bd_intf_pins quadrant_switcher_1/s_axi] [get_bd_intf_pins axi_interconnect/M19_AXI]
  ...
  connect_bd_intf_net -intf_net quadrant_switcher_1_m_axi [get_bd_intf_pins quadrant_switcher_1/m_axi] [get_bd_intf_pins smartconnect_0/S00_AXI]
  ...
  connect_bd_net -net Net2  [get_bd_ports switches] \
  [get_bd_pins gpio_sws/gpio_io_i] \
  [get_bd_pins splicer_gpio_config_0/switch]
  ...
  [get_bd_pins quadrant_switcher_1/resetn] \
  ...
  [get_bd_pins quadrant_switcher_1/clk]
  ...
  connect_bd_net -net pmod1_intr_req  [get_bd_pins xlconcat0/In6]
  connect_bd_net -net quadrant_switcher_1_quadrant_out  [get_bd_pins quadrant_switcher_1/quadrant_out] \
  [get_bd_pins splicer_gpio_config_0/quadrant]
  connect_bd_net -net splicer_gpio_config_0_header  [get_bd_pins splicer_gpio_config_0/header] \
  [get_bd_ports header]
  connect_bd_net -net splicer_gpio_config_0_leds  [get_bd_pins splicer_gpio_config_0/leds] \
  [get_bd_ports leds]
  connect_bd_net -net video_mm2s_introut  [get_bd_pins video/mm2s_introut] \
  [get_bd_pins xlconcat0/In4] \
  [get_bd_pins quadrant_switcher_1/frame_done]
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces address_remap_0/M_AXI_out] [get_bd_addr_segs ps_e_0/SAXIGP6/LPD_DDR_LOW] -force
  ...
  assign_bd_address -offset 0x80047000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs quadrant_switcher_1/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x80042000 -range 0x00001000 -target_address_space [get_bd_addr_spaces quadrant_switcher_1/m_axi] [get_bd_addr_segs video/axi_vdma/S_AXI_LITE/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces address_remap_0/M_AXI_out] [get_bd_addr_segs ps_e_0/SAXIGP6/LPD_LPS_OCM]
  exclude_bd_addr_seg -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces address_remap_0/M_AXI_out] [get_bd_addr_segs ps_e_0/SAXIGP6/LPD_QSPI]
