...
xilinx.com:hls:quadrant_switcher:1.0\
...
proc create_hier_cell_phy { parentCell nameHier } {
  ...
  connect_bd_net -net net_bdry_in_HDMI_RX_CLK_N_IN  [get_bd_pins HDMI_RX_CLK_N_IN] \
  [get_bd_pins vid_phy_controller/mgtrefclk1_pad_n_in]
  connect_bd_net -net net_bdry_in_HDMI_RX_CLK_P_IN  [get_bd_pins HDMI_RX_CLK_P_IN] \
  [get_bd_pins vid_phy_controller/mgtrefclk1_pad_p_in]
  connect_bd_net -net net_bdry_in_HDMI_RX_DAT_N_IN  [get_bd_pins HDMI_RX_DAT_N_IN] \
  [get_bd_pins vid_phy_controller/phy_rxn_in]
  connect_bd_net -net net_bdry_in_HDMI_RX_DAT_P_IN  [get_bd_pins HDMI_RX_DAT_P_IN] \
  [get_bd_pins vid_phy_controller/phy_rxp_in]
  connect_bd_net -net net_bdry_in_IDT_8T49N241_LOL_IN  [get_bd_pins IDT_8T49N241_LOL_IN] \
  [get_bd_pins vid_phy_controller/tx_refclk_rdy]
  connect_bd_net -net net_bdry_in_TX_REFCLK_N_IN  [get_bd_pins TX_REFCLK_N_IN] \
  [get_bd_pins vid_phy_controller/mgtrefclk0_pad_n_in]
  connect_bd_net -net net_bdry_in_TX_REFCLK_P_IN  [get_bd_pins TX_REFCLK_P_IN] \
  ...
  [get_bd_pins vid_phy_controller/gtnorthrefclk1_odiv2_in]
  ...
  [get_bd_pins vid_phy_rx_axi4s_aclk] \
  ...
  [get_bd_pins vid_phy_tx_axi4s_aclk] \
  [get_bd_pins vid_phy_controller/vid_phy_tx_axi4s_aclk]
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn  [get_bd_pins s_axi_cpu_aresetn] \
  [get_bd_pins vid_phy_controller/vid_phy_sb_aresetn] \
  [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aresetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk  [get_bd_pins s_axi_cpu_aclk] \
...
proc create_hier_cell_hdmi_out { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net acr_valid_1  [get_bd_pins acr_valid] \
  [get_bd_pins frontend/acr_valid]
  connect_bd_net -net net_bdry_in_TX_HPD_IN  [get_bd_pins TX_HPD_IN] \
  [get_bd_pins frontend/hpd]
  connect_bd_net -net net_v_hdmi_rx_ss_fid  [get_bd_pins fid] \
  [get_bd_pins frontend/fid]
  connect_bd_net -net net_v_hdmi_tx_ss_irq  [get_bd_pins frontend/irq] \
  [get_bd_pins irq1]
  connect_bd_net -net net_v_hdmi_tx_ss_locked  [get_bd_pins frontend/locked]
  connect_bd_net -net net_vid_phy_controller_tx_video_clk  [get_bd_pins video_clk] \
  [get_bd_pins frontend/video_clk]
  connect_bd_net -net net_vid_phy_controller_txoutclk  [get_bd_pins link_clk] \
  [get_bd_pins frontend/link_clk]
  connect_bd_net -net net_zynq_us_ss_0_clk_out2  [get_bd_pins aclk] \
  [get_bd_pins color_convert/ap_clk] \
  [get_bd_pins pixel_unpack/ap_clk] \
  [get_bd_pins frontend/s_axis_video_aclk] \
  [get_bd_pins pixel_reorder/aclk] \
  [get_bd_pins tx_video_axis_reg_slice/aclk]
  connect_bd_net -net net_zynq_us_ss_0_dcm_locked  [get_bd_pins aresetn] \
  [get_bd_pins color_convert/ap_rst_n] \
  [get_bd_pins pixel_unpack/ap_rst_n] \
  [get_bd_pins frontend/s_axis_video_aresetn] \
  [get_bd_pins pixel_reorder/aresetn] \
  [get_bd_pins tx_video_axis_reg_slice/aresetn]
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn  [get_bd_pins s_axi_cpu_aresetn] \
  [get_bd_pins frontend/s_axi_cpu_aresetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk  [get_bd_pins s_axi_cpu_aclk] \
  [get_bd_pins frontend/s_axi_cpu_aclk]
  connect_bd_net -net s_axis_audio_aclk_1  [get_bd_pins s_axis_audio_aclk] \
  [get_bd_pins frontend/s_axis_audio_aclk]
  connect_bd_net -net s_axis_audio_aresetn_1  [get_bd_pins s_axis_audio_aresetn] \
  [get_bd_pins frontend/s_axis_audio_aresetn]
...
proc create_hier_cell_hdmi_in { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net net_bdry_in_RX_DET_IN  [get_bd_pins RX_DET_IN] \
  [get_bd_pins frontend/cable_detect]
  connect_bd_net -net net_v_hdmi_rx_ss_fid  [get_bd_pins frontend/fid] \
  [get_bd_pins fid]
  connect_bd_net -net net_v_hdmi_rx_ss_hpd  [get_bd_pins frontend/hpd] \
  [get_bd_pins RX_HPD_OUT]
  connect_bd_net -net net_v_hdmi_rx_ss_irq  [get_bd_pins frontend/irq] \
  [get_bd_pins irq]
  connect_bd_net -net net_vid_phy_controller_rx_video_clk  [get_bd_pins video_clk] \
  [get_bd_pins frontend/video_clk]
  connect_bd_net -net net_vid_phy_controller_rxoutclk  [get_bd_pins link_clk] \
  [get_bd_pins frontend/link_clk]
  connect_bd_net -net net_zynq_us_ss_0_clk_out2  [get_bd_pins aclk] \
  [get_bd_pins color_convert/ap_clk] \
...
proc create_hier_cell_video { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net axi_vdma_0_mm2s_introut  [get_bd_pins axi_vdma/mm2s_introut] \
  [get_bd_pins mm2s_introut]
  connect_bd_net -net axi_vdma_0_s2mm_introut  [get_bd_pins axi_vdma/s2mm_introut] \
  [get_bd_pins s2mm_introut]
  connect_bd_net -net const_gnd_dout  [get_bd_pins const_gnd/dout] \
  [get_bd_pins hdmi_in/s_axis_audio_aclk] \
  [get_bd_pins hdmi_in/s_axis_audio_aresetn] \
  [get_bd_pins hdmi_out/acr_valid] \
  [get_bd_pins hdmi_out/s_axis_audio_aclk] \
  [get_bd_pins hdmi_out/s_axis_audio_aresetn]
  connect_bd_net -net net_bdry_in_HDMI_RX_CLK_N_IN  [get_bd_pins HDMI_RX_CLK_N_IN] \
  [get_bd_pins phy/HDMI_RX_CLK_N_IN]
  connect_bd_net -net net_bdry_in_HDMI_RX_CLK_P_IN  [get_bd_pins HDMI_RX_CLK_P_IN] \
  [get_bd_pins phy/HDMI_RX_CLK_P_IN]
  connect_bd_net -net net_bdry_in_HDMI_RX_DAT_N_IN  [get_bd_pins HDMI_RX_DAT_N_IN] \
  [get_bd_pins phy/HDMI_RX_DAT_N_IN]
  connect_bd_net -net net_bdry_in_HDMI_RX_DAT_P_IN  [get_bd_pins HDMI_RX_DAT_P_IN] \
  [get_bd_pins phy/HDMI_RX_DAT_P_IN]
  connect_bd_net -net net_bdry_in_IDT_8T49N241_LOL_IN  [get_bd_pins IDT_8T49N241_LOL_IN] \
  [get_bd_pins phy/IDT_8T49N241_LOL_IN]
  connect_bd_net -net net_bdry_in_RX_DET_IN  [get_bd_pins RX_DET_IN] \
  [get_bd_pins hdmi_in/RX_DET_IN]
  connect_bd_net -net net_bdry_in_TX_HPD_IN  [get_bd_pins TX_HPD_IN] \
  [get_bd_pins hdmi_out/TX_HPD_IN]
  connect_bd_net -net net_bdry_in_TX_REFCLK_N_IN  [get_bd_pins TX_REFCLK_N_IN] \
  [get_bd_pins phy/TX_REFCLK_N_IN]
  connect_bd_net -net net_bdry_in_TX_REFCLK_P_IN  [get_bd_pins TX_REFCLK_P_IN] \
  [get_bd_pins phy/TX_REFCLK_P_IN]
  connect_bd_net -net net_v_hdmi_rx_ss_hpd  [get_bd_pins hdmi_in/RX_HPD_OUT] \
  [get_bd_pins RX_HPD_OUT]
  connect_bd_net -net net_v_hdmi_rx_ss_irq  [get_bd_pins hdmi_in/irq] \
  [get_bd_pins irq]
  connect_bd_net -net net_v_hdmi_tx_ss_irq  [get_bd_pins hdmi_out/irq1] \
  [get_bd_pins irq1]
  connect_bd_net -net net_vcc_const_dout  [get_bd_pins TX_EN_OUT] \
  [get_bd_pins phy/TX_EN_OUT]
  connect_bd_net -net net_vid_phy_controller_irq  [get_bd_pins phy/irq2] \
  [get_bd_pins irq2]
  connect_bd_net -net net_vid_phy_controller_phy_txn_out  [get_bd_pins phy/HDMI_TX_DAT_N_OUT] \
  [get_bd_pins HDMI_TX_DAT_N_OUT]
  connect_bd_net -net net_vid_phy_controller_phy_txp_out  [get_bd_pins phy/HDMI_TX_DAT_P_OUT] \
  [get_bd_pins HDMI_TX_DAT_P_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_n  [get_bd_pins phy/RX_REFCLK_N_OUT] \
  [get_bd_pins RX_REFCLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_p  [get_bd_pins phy/RX_REFCLK_P_OUT] \
  [get_bd_pins RX_REFCLK_P_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_video_clk  [get_bd_pins phy/rx_video_clk] \
  [get_bd_pins hdmi_in/video_clk]
  connect_bd_net -net net_vid_phy_controller_rxoutclk  [get_bd_pins phy/vid_phy_rx_axi4s_aclk] \
  [get_bd_pins hdmi_in/link_clk]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_n  [get_bd_pins phy/HDMI_TX_CLK_N_OUT] \
  [get_bd_pins HDMI_TX_CLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_p  [get_bd_pins phy/HDMI_TX_CLK_P_OUT] \
  [get_bd_pins HDMI_TX_CLK_P_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_video_clk  [get_bd_pins phy/tx_video_clk] \
  [get_bd_pins hdmi_out/video_clk]
  connect_bd_net -net net_vid_phy_controller_txoutclk  [get_bd_pins phy/vid_phy_tx_axi4s_aclk] \
  [get_bd_pins hdmi_out/link_clk]
  connect_bd_net -net net_zynq_us_ss_0_clk_out2  [get_bd_pins aclk] \
  [get_bd_pins hdmi_in/aclk] \
  [get_bd_pins hdmi_out/aclk] \
  ...
  connect_bd_net -net net_zynq_us_ss_0_dcm_locked  [get_bd_pins aresetn] \
  [get_bd_pins hdmi_in/aresetn] \
  [get_bd_pins hdmi_out/aresetn]
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn  [get_bd_pins s_axi_cpu_aresetn] \
  [get_bd_pins hdmi_in/s_axi_cpu_aresetn] \
  [get_bd_pins hdmi_out/s_axi_cpu_aresetn] \
  [get_bd_pins phy/s_axi_cpu_aresetn] \
  [get_bd_pins axi_vdma/axi_resetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk  [get_bd_pins s_axi_cpu_aclk] \
  [get_bd_pins hdmi_in/s_axi_cpu_aclk] \
  [get_bd_pins hdmi_out/s_axi_cpu_aclk] \
  [get_bd_pins phy/s_axi_cpu_aclk] \
...
proc create_hier_cell_iop_pmod1 { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net dff_en_reset_vector_0_q  [get_bd_pins dff_en_reset_vector_0/q] \
  [get_bd_pins intr_req]
  connect_bd_net -net io_data_i_0_1  [get_bd_pins data_i] \
  [get_bd_pins io_switch/io_data_i]
  connect_bd_net -net io_switch_0_timer_i  [get_bd_pins io_switch/timer_i] \
  [get_bd_pins timer/capturetrig0]
  connect_bd_net -net io_switch_io_data_o  [get_bd_pins io_switch/io_data_o] \
  [get_bd_pins data_o]
  connect_bd_net -net io_switch_io_tri_o  [get_bd_pins io_switch/io_tri_o] \
  [get_bd_pins tri_o]
  connect_bd_net -net iop_pmoda_intr_ack_1  [get_bd_pins intr_ack] \
  [get_bd_pins dff_en_reset_vector_0/reset]
  connect_bd_net -net iop_pmoda_intr_gpio_io_o  [get_bd_pins intr/gpio_io_o] \
  [get_bd_pins dff_en_reset_vector_0/en]
  connect_bd_net -net logic_1_dout1  [get_bd_pins logic_1/dout] \
  [get_bd_pins dff_en_reset_vector_0/d] \
  [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in]
  connect_bd_net -net mb1_iic_iic2intc_irpt  [get_bd_pins iic/iic2intc_irpt] \
  [get_bd_pins intr_concat/In0]
  connect_bd_net -net mb1_interrupt_concat_dout  [get_bd_pins intr_concat/dout] \
  [get_bd_pins intc/intr]
  connect_bd_net -net mb1_spi_ip2intc_irpt  [get_bd_pins spi/ip2intc_irpt] \
  [get_bd_pins intr_concat/In1]
  connect_bd_net -net mb1_timer_generateout0  [get_bd_pins timer/generateout0] \
  [get_bd_pins io_switch/timer_o]
  connect_bd_net -net mb1_timer_interrupt  [get_bd_pins timer/interrupt] \
  [get_bd_pins intr_concat/In2]
  connect_bd_net -net mb1_timer_pwm0  [get_bd_pins timer/pwm0] \
  [get_bd_pins io_switch/pwm_o]
  connect_bd_net -net mb_1_reset_Dout  [get_bd_pins aux_reset_in] \
  ...
  connect_bd_net -net ps7_0_FCLK_CLK0  [get_bd_pins clk_100M] \
  [get_bd_pins dff_en_reset_vector_0/clk] \
  [get_bd_pins io_switch/s_axi_aclk] \
  [get_bd_pins lmb/LMB_Clk] \
  [get_bd_pins gpio/s_axi_aclk] \
  [get_bd_pins iic/s_axi_aclk] \
  [get_bd_pins intc/s_axi_aclk] \
  [get_bd_pins intr/s_axi_aclk] \
  [get_bd_pins mb/Clk] \
  [get_bd_pins mb_bram_ctrl/s_axi_aclk] \
  ...
  [get_bd_pins iic/s_axi_aresetn] \
  [get_bd_pins intc/s_axi_aresetn] \
  ...
  [get_bd_pins io_switch/s_axi_aresetn] \
  [get_bd_pins intr/s_axi_aresetn] \
  [get_bd_pins mb_bram_ctrl/s_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_MI {21} $axi_interconnect
...
\
  ...
  # Create instance: quadrant_switcher_0, and set properties
  set quadrant_switcher_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:quadrant_switcher:1.0 quadrant_switcher_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M03_AXI [get_bd_intf_pins axi_interconnect/M03_AXI] [get_bd_intf_pins smartconnect_0/S01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M19_AXI [get_bd_intf_pins axi_interconnect/M19_AXI] [get_bd_intf_pins quadrant_switcher_0/s_axi_control]
  connect_bd_intf_net -intf_net axi_interconnect_M20_AXI [get_bd_intf_pins axi_interconnect/M20_AXI] [get_bd_intf_pins quadrant_switcher_0/s_axi_ctrl]
  ...
  connect_bd_intf_net -intf_net quadrant_switcher_0_m_axi_vdma [get_bd_intf_pins quadrant_switcher_0/m_axi_vdma] [get_bd_intf_pins smartconnect_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins video/S_AXI_LITE]

  # Create port connections
  connect_bd_net -net ARESETN_1  [get_bd_pins proc_sys_reset_1/interconnect_aresetn] \
  [get_bd_pins axi_mem_intercon/ARESETN] \
  [get_bd_pins axi_mem_intercon_1/ARESETN]
  connect_bd_net -net Net  [get_bd_ports pmod0] \
  [get_bd_pins pmod0_buf/IOBUF_IO_IO]
  connect_bd_net -net Net1  [get_bd_ports pmod1] \
  [get_bd_pins pmod1_buf/IOBUF_IO_IO]
  connect_bd_net -net axi_gpio_0_gpio_io_o  [get_bd_pins reset_control/gpio_io_o] \
  [get_bd_pins xlslice_0/Din] \
  [get_bd_pins xlslice_1/Din]
  connect_bd_net -net axi_intc_0_irq  [get_bd_pins axi_intc_0/irq] \
  [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_vdma_0_s2mm_introut  [get_bd_pins video/s2mm_introut] \
  [get_bd_pins xlconcat0/In3]
  connect_bd_net -net data_i_1  [get_bd_pins pmod0_buf/IOBUF_IO_O] \
  [get_bd_pins iop_pmod0/data_i]
  connect_bd_net -net data_i_2  [get_bd_pins pmod1_buf/IOBUF_IO_O] \
  [get_bd_pins iop_pmod1/data_i]
  connect_bd_net -net gpio_btns_ip2intc_irpt  [get_bd_pins gpio_btns/ip2intc_irpt] \
  [get_bd_pins xlconcat0/In8]
  connect_bd_net -net gpio_sws_ip2intc_irpt  [get_bd_pins gpio_sws/ip2intc_irpt] \
  [get_bd_pins xlconcat0/In7]
  connect_bd_net -net mb_pmod1_intr_ack_Dout  [get_bd_pins mb_iop_pmod1_intr_ack/Dout] \
  [get_bd_pins iop_pmod1/intr_ack]
  connect_bd_net -net mb_pmod1_reset_Dout  [get_bd_pins mb_iop_pmod1_reset/Dout] \
  [get_bd_pins iop_pmod1/aux_reset_in]
  connect_bd_net -net mdm_0_Debug_SYS_Rst  [get_bd_pins mdm/Debug_SYS_Rst] \
  [get_bd_pins iop_pmod0/mb_debug_sys_rst] \
  [get_bd_pins iop_pmod1/mb_debug_sys_rst]
  connect_bd_net -net net_bdry_in_HDMI_RX_CLK_N_IN  [get_bd_ports HDMI_RX_CLK_N_IN] \
  [get_bd_pins video/HDMI_RX_CLK_N_IN]
  connect_bd_net -net net_bdry_in_HDMI_RX_CLK_P_IN  [get_bd_ports HDMI_RX_CLK_P_IN] \
  [get_bd_pins video/HDMI_RX_CLK_P_IN]
  connect_bd_net -net net_bdry_in_HDMI_RX_DAT_N_IN  [get_bd_ports HDMI_RX_DAT_N_IN] \
  [get_bd_pins video/HDMI_RX_DAT_N_IN]
  connect_bd_net -net net_bdry_in_HDMI_RX_DAT_P_IN  [get_bd_ports HDMI_RX_DAT_P_IN] \
  [get_bd_pins video/HDMI_RX_DAT_P_IN]
  connect_bd_net -net net_bdry_in_IDT_8T49N241_LOL_IN  [get_bd_ports IDT_8T49N241_LOL_IN] \
  [get_bd_pins video/IDT_8T49N241_LOL_IN]
  connect_bd_net -net net_bdry_in_RX_DET_IN  [get_bd_ports RX_DET_IN] \
  [get_bd_pins video/RX_DET_IN]
  connect_bd_net -net net_bdry_in_TX_HPD_IN  [get_bd_ports TX_HPD_IN] \
  [get_bd_pins video/TX_HPD_IN]
  connect_bd_net -net net_bdry_in_TX_REFCLK_N_IN  [get_bd_ports TX_REFCLK_N_IN] \
  [get_bd_pins video/TX_REFCLK_N_IN]
  connect_bd_net -net net_bdry_in_TX_REFCLK_P_IN  [get_bd_ports TX_REFCLK_P_IN] \
  [get_bd_pins video/TX_REFCLK_P_IN]
  ...
  connect_bd_net -net net_rst_processor_1_100M_interconnect_aresetn  [get_bd_pins proc_sys_reset_0/interconnect_aresetn] \
  [get_bd_pins axi_interconnect/ARESETN] \
  [get_bd_pins axi_interconnect_0/ARESETN]
  connect_bd_net -net net_v_hdmi_rx_ss_hpd  [get_bd_pins video/RX_HPD_OUT] \
  [get_bd_ports RX_HPD_OUT]
  connect_bd_net -net net_v_hdmi_rx_ss_irq  [get_bd_pins video/irq] \
  [get_bd_pins xlconcat0/In1]
  connect_bd_net -net net_v_hdmi_tx_ss_irq  [get_bd_pins video/irq1] \
  [get_bd_pins xlconcat0/In2]
  connect_bd_net -net net_vcc_const_dout  [get_bd_pins vcc_const/dout] \
  [get_bd_ports TX_EN_OUT] \
  [get_bd_pins video/TX_EN_OUT]
  connect_bd_net -net net_vid_phy_controller_irq  [get_bd_pins video/irq2] \
  [get_bd_pins xlconcat0/In0]
  connect_bd_net -net net_vid_phy_controller_phy_txn_out  [get_bd_pins video/HDMI_TX_DAT_N_OUT] \
  [get_bd_ports HDMI_TX_DAT_N_OUT]
  connect_bd_net -net net_vid_phy_controller_phy_txp_out  [get_bd_pins video/HDMI_TX_DAT_P_OUT] \
  [get_bd_ports HDMI_TX_DAT_P_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_n  [get_bd_pins video/RX_REFCLK_N_OUT] \
  [get_bd_ports RX_REFCLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_p  [get_bd_pins video/RX_REFCLK_P_OUT] \
  [get_bd_ports RX_REFCLK_P_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_n  [get_bd_pins video/HDMI_TX_CLK_N_OUT] \
  [get_bd_ports HDMI_TX_CLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_p  [get_bd_pins video/HDMI_TX_CLK_P_OUT] \
  [get_bd_ports HDMI_TX_CLK_P_OUT]
  connect_bd_net -net net_zynq_us_pl_resetn0  [get_bd_pins ps_e_0/pl_resetn0] \
  ...
  [get_bd_pins proc_sys_reset_3/aux_reset_in] \
  [get_bd_pins proc_sys_reset_3/dcm_locked]
  connect_bd_net -net net_zynq_us_ss_0_clk_out2  [get_bd_pins ps_e_0/pl_clk1] \
  [get_bd_pins video/aclk] \
  [get_bd_pins axi_interconnect/M07_ACLK] \
  [get_bd_pins axi_interconnect/M08_ACLK] \
  [get_bd_pins axi_interconnect/M09_ACLK] \
  [get_bd_pins axi_interconnect/M10_ACLK] \
  [get_bd_pins axi_interconnect/M16_ACLK] \
  [get_bd_pins axi_interconnect/M18_ACLK] \
  ...
  [get_bd_pins ps_e_0/saxihp0_fpd_aclk] \
  [get_bd_pins ps_e_0/saxihp2_fpd_aclk] \
  [get_bd_pins shutdown_HP0_FPD/clk] \
  [get_bd_pins shutdown_HP2_FPD/clk]
  connect_bd_net -net net_zynq_us_ss_0_dcm_locked  [get_bd_pins proc_sys_reset_1/peripheral_aresetn] \
  [get_bd_pins video/aresetn] \
  [get_bd_pins axi_interconnect/M07_ARESETN] \
  [get_bd_pins axi_interconnect/M08_ARESETN] \
  [get_bd_pins axi_interconnect/M09_ARESETN] \
  [get_bd_pins axi_interconnect/M10_ARESETN] \
  [get_bd_pins axi_interconnect/M16_ARESETN] \
  [get_bd_pins axi_interconnect/M18_ARESETN] \
  ...
  [get_bd_pins shutdown_HP2_FPD/resetn]
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn  [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
  [get_bd_pins iop_pmod0/s_axi_aresetn] \
  [get_bd_pins iop_pmod1/s_axi_aresetn] \
  ...
  [get_bd_pins axi_interconnect/M02_ARESETN] \
  [get_bd_pins axi_interconnect/M03_ARESETN] \
  [get_bd_pins axi_interconnect/M04_ARESETN] \
  [get_bd_pins axi_interconnect/M05_ARESETN] \
  [get_bd_pins axi_interconnect/M06_ARESETN] \
  [get_bd_pins axi_interconnect/M11_ARESETN] \
  [get_bd_pins axi_interconnect/M12_ARESETN] \
  [get_bd_pins axi_interconnect/M13_ARESETN] \
  [get_bd_pins axi_interconnect/M14_ARESETN] \
  [get_bd_pins axi_interconnect/M15_ARESETN] \
  [get_bd_pins axi_interconnect/M17_ARESETN] \
  [get_bd_pins axi_interconnect_0/M00_ARESETN] \
  [get_bd_pins fmch_axi_iic/s_axi_aresetn] \
  [get_bd_pins gpio_btns/s_axi_aresetn] \
  [get_bd_pins gpio_leds/s_axi_aresetn] \
  [get_bd_pins gpio_sws/s_axi_aresetn] \
  [get_bd_pins reset_control/s_axi_aresetn] \
  [get_bd_pins axi_interconnect/M19_ARESETN] \
  [get_bd_pins axi_interconnect/M20_ARESETN] \
  [get_bd_pins smartconnect_0/aresetn] \
  [get_bd_pins quadrant_switcher_0/ap_rst_n]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk  [get_bd_pins ps_e_0/pl_clk0] \
  [get_bd_pins address_remap_0/m_axi_out_aclk] \
  [get_bd_pins address_remap_0/s_axi_in_aclk] \
  [get_bd_pins iop_pmod0/clk_100M] \
  [get_bd_pins iop_pmod1/clk_100M] \
  ...
  [get_bd_pins axi_interconnect/M02_ACLK] \
  [get_bd_pins axi_interconnect/M03_ACLK] \
  [get_bd_pins axi_interconnect/M04_ACLK] \
  [get_bd_pins axi_interconnect/M05_ACLK] \
  [get_bd_pins axi_interconnect/M06_ACLK] \
  [get_bd_pins axi_interconnect/M11_ACLK] \
  [get_bd_pins axi_interconnect/M12_ACLK] \
  [get_bd_pins axi_interconnect/M13_ACLK] \
  [get_bd_pins axi_interconnect/M14_ACLK] \
  [get_bd_pins axi_interconnect/M15_ACLK] \
  [get_bd_pins axi_interconnect/M17_ACLK] \
  [get_bd_pins axi_interconnect_0/ACLK] \
  [get_bd_pins axi_interconnect_0/S00_ACLK] \
  [get_bd_pins axi_interconnect_0/M00_ACLK] \
  [get_bd_pins axi_interconnect_0/S01_ACLK] \
  [get_bd_pins fmch_axi_iic/s_axi_aclk] \
  [get_bd_pins gpio_btns/s_axi_aclk] \
  [get_bd_pins gpio_leds/s_axi_aclk] \
  [get_bd_pins gpio_sws/s_axi_aclk] \
  [get_bd_pins proc_sys_reset_0/slowest_sync_clk] \
  [get_bd_pins ps_e_0/maxihpm0_lpd_aclk] \
  [get_bd_pins ps_e_0/saxi_lpd_aclk] \
  [get_bd_pins reset_control/s_axi_aclk] \
  [get_bd_pins shutdown_LPD/clk] \
  [get_bd_pins smartconnect_0/aclk] \
  [get_bd_pins axi_interconnect/M19_ACLK] \
  [get_bd_pins axi_interconnect/M20_ACLK] \
  [get_bd_pins quadrant_switcher_0/ap_clk]
  connect_bd_net -net pmod0_data_o  [get_bd_pins iop_pmod0/data_o] \
  [get_bd_pins pmod0_buf/IOBUF_IO_I]
  connect_bd_net -net pmod0_intr_req  [get_bd_pins iop_pmod0/intr_req] \
  [get_bd_pins xlconcat0/In5]
  connect_bd_net -net pmod0_intr_req_Dout  [get_bd_pins mb_iop_pmod0_intr_ack/Dout] \
  [get_bd_pins iop_pmod0/intr_ack]
  connect_bd_net -net pmod0_peripheral_aresetn  [get_bd_pins iop_pmod0/peripheral_aresetn] \
  [get_bd_pins axi_interconnect_0/S00_ARESETN]
  connect_bd_net -net pmod0_reset_Dout  [get_bd_pins mb_iop_pmod0_reset/Dout] \
  [get_bd_pins iop_pmod0/aux_reset_in]
  connect_bd_net -net pmod0_tri_o  [get_bd_pins iop_pmod0/tri_o] \
  [get_bd_pins pmod0_buf/IOBUF_IO_T]
  connect_bd_net -net pmod1_data_o  [get_bd_pins iop_pmod1/data_o] \
  [get_bd_pins pmod1_buf/IOBUF_IO_I]
  connect_bd_net -net pmod1_intr_req  [get_bd_pins iop_pmod1/intr_req] \
  [get_bd_pins xlconcat0/In6]
  connect_bd_net -net pmod1_peripheral_aresetn  [get_bd_pins iop_pmod1/peripheral_aresetn] \
  [get_bd_pins address_remap_0/m_axi_out_aresetn] \
  [get_bd_pins address_remap_0/s_axi_in_aresetn] \
  [get_bd_pins axi_interconnect_0/S01_ARESETN] \
  [get_bd_pins shutdown_LPD/resetn]
  connect_bd_net -net pmod1_tri_o  [get_bd_pins iop_pmod1/tri_o] \
  [get_bd_pins pmod1_buf/IOBUF_IO_T]
  connect_bd_net -net video_mm2s_introut  [get_bd_pins video/mm2s_introut] \
  [get_bd_pins xlconcat0/In4] \
  [get_bd_pins quadrant_switcher_0/frame_done]
  connect_bd_net -net xlconcat0_dout  [get_bd_pins xlconcat0/dout] \
  [get_bd_pins axi_intc_0/intr]
  connect_bd_net -net xlconcat_0_dout  [get_bd_pins xlconcat_0/dout] \
  [get_bd_pins ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconcat_1_dout  [get_bd_pins xlconcat_1/dout] \
  [get_bd_pins ps_e_0/pl_ps_irq1]
  connect_bd_net -net xlconstant_0_dout  [get_bd_pins xlconstant_0/dout] \
  [get_bd_pins quadrant_switcher_0/enable]
  connect_bd_net -net xlslice_0_Dout  [get_bd_pins xlslice_0/Dout] \
  [get_bd_ports IDT_8T49N241_RST_OUT]
  connect_bd_net -net xlslice_1_Dout  [get_bd_pins xlslice_1/Dout] \
  [get_bd_ports HDMI_RX_LS_OE]
  connect_bd_net -net zynq_us_emio_gpio_o  [get_bd_pins ps_e_0/emio_gpio_o] \
  [get_bd_pins mb_iop_pmod0_intr_ack/Din] \
  [get_bd_pins mb_iop_pmod0_reset/Din] \
  [get_bd_pins mb_iop_pmod1_intr_ack/Din] \
  [get_bd_pins mb_iop_pmod1_reset/Din]
  connect_bd_net -net zynq_us_pl_clk2  [get_bd_pins ps_e_0/pl_clk2] \
  [get_bd_pins proc_sys_reset_2/slowest_sync_clk]
  connect_bd_net -net zynq_us_pl_clk3  [get_bd_pins ps_e_0/pl_clk3] \
  ...
  assign_bd_address -offset 0x800E0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs quadrant_switcher_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0x800F0000 -range 0x00010000 -with_name SEG_quadrant_switcher_0_Reg_1 -target_address_space [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs quadrant_switcher_0/s_axi_ctrl/Reg] -force
  ...
  assign_bd_address -offset 0x80042000 -range 0x00001000 -target_address_space [get_bd_addr_spaces quadrant_switcher_0/Data_m_axi_vdma] [get_bd_addr_segs video/axi_vdma/S_AXI_LITE/Reg] -force
